...
void autonomous() {
        ...
        if(auton == 1){
            ...
            chassis.moveToPoint(-33, -35, 500, false);
            chassis.waitUntilDone();            
            chassis.follow(path_skills3_txt, 14, 2200, false);
            pros::delay(700);
            ...
            wingRight.set_value(0);
            chassis.waitUntilDone();
            chassis.moveToPoint(65, 38, 800, true);
            chassis.waitUntilDone();
            chassis.moveToPoint(70, 25, 1000, false);
            chassis.waitUntilDone();
            chassis.moveToPoint(65, 38, 800, true);
            chassis.moveToPoint(70, 25, 1000, false);
            chassis.waitUntilDone();
